...
(function() {
  var Table, colors, commands, context, evalLines, myParse, name, nesh, options, program, reg, registers, registersString, registersTable;
  ...
  context = function() {
    var __checkAddress, __checkID, comm, dump, read, scan, status, stty, write;
